...
let color = pedirOpcion("Elija el color del personaje:\n1-Negro\n2-Blanco\n3-Marron\n4-Arcoiris\n5-Amarillo", ["1", "2", "3", "4", "5"]);
let colors = ["Negro", "Blanco", "Marron", "Arcoiris", "Amarillo"];
personaje.color = colors[parseInt(color) - 1];
...
alert("¡Personaje creado!" + personaje);
